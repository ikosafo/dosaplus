...
<head>
    <title>Dosaplus Logistics </title>
...
<body>
<!--  Header  -->
<header class="background-white" style="position: fixed;width: 100% !important">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-9 col-lg-12">
                                <div class="row">
                                    <div class="col-md-4"><i class="fa fa-phone margin-right-10px"></i> +233(24)9429735 / +4917669193480</div>
                                    <div class="col-md-4"><i class="fa fa-envelope-o margin-right-10px"></i> info@dosapluslogistics.com</div>
                                    <div class="col-md-4"><i class="fa fa-map-marker margin-right-10px"></i> Rheinische Str 30, Dortmund 44137</div>
                                </div>
                            </div>
                    ...
                    <div class="position-relative">
                        <div class="row">
                            <div class="col-lg-3 col-md-12">
                                <a id="logo" href="index.php" class="d-inline-block margin-tb-4px">
                                    <img src="assets/img/logo.jpeg" alt="" style="width: 53%"></a>
                            ...
                            <div class="col-lg-7 col-md-12 position-inherit">
                                <ul id="menu-main" class="nav-menu float-xl-left text-lg-center link-padding-tb-25px dropdown-dark">
                                    ...
                                    <li class="has-dropdown"><a href="#">Services</a>
                                        <ul class="sub-menu">
                                            <li><a href="servicecargo.php">Cargo Transportation</a></li>
                                            <li><a href="serviceair.php">Air Freight</a></li>
...
<div class="modal contact-modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content margin-top-50px background-main-color">
            <div class="row no-gutters">
                <div class="col-lg-5">
                    <img src="assets/img/quote.jpeg" alt="">
                </div>
                <div class="col-lg-7">
                    <div class="padding-30px">
                        ...
                        <form>
                            ...
                            <div class="form-group">
                                <label>Address</label>
                                <input type="text" class="form-control" id="inputAddress" placeholder="Enter Address here">
                            </div>
                            <div class="form-group">
                                <label>Message</label>
