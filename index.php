<?php require('inc/header.php'); ?>
    ...
    <div id="rev_slider_5_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container"
         data-alias="logistics" data-source="gallery"
        ...
        <div id="rev_slider_5_1" class="rev_slider fullwidthabanner" style="display:none" data-version="5.4.8">
            <ul>
                ...
                <li data-index="rs-8" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                    ...
                    <!-- MAIN IMAGE -->
                    <img src="assets/rslider/assets/29cca-slider-5.jpg" alt="" data-bgposition="center center"
                    ...
                    <div class="tp-caption   tp-resizeme" id="slide-8-layer-1" data-x="['left','left','left','center']"
                         ...
                         style="z-index: 5; min-width: 461px; max-width: 461px; max-width: 173px; max-width: 173px;
                         white-space: nowrap; font-size: 50px; line-height: 59px; font-weight: 400;
                         color: #000000; letter-spacing: -4px;font-family:Poppins;margin-top: 13%">
                    ...
                    <div class="tp-caption rev-btn " id="slide-8-layer-2" data-x="['left','left','left','center']"
                         ...
                         style="z-index: 6; white-space: nowrap; font-size: 14px; line-height: 17px;
                         font-weight: 500; color: rgba(255,255,255,1); letter-spacing: px;
                         font-family:Poppins;background-color:#0F520F;
                         border-color:#0F520F;border-style:solid;border-width:2px 2px 2px 2px;
                         border-radius:30px 30px 30px 30px;outline:none;box-shadow:none;
            ...
            <div class="section-title margin-bottom-40px">
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        ...
                        <div class="des">Dosa Plus Logistics offers excellent services to clients
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="service-icon-box">
                        ...
                        <div class="des">We provide a standby rider to collect all parcels from your office
                            ...
                            you to pick documents from your clients.
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="service-icon-box">
                        ...
                        <a href="#" class="title h2">Cargo Tracking</a>
                        <div class="des">This is a crucial service offered by our company. With the help of GPS
                            technology and a unique tracking number, you can know the status of your shipment
                            at a given point of the day.
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="service-icon-box">
                        ...
                        <div class="des">We provide a safe secure storage area for the top finance bank packages.
                            ...
                            avoid loss, theft and damage of the packages.
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="service-icon-box">
                        ...
                        <a href="#" class="title h2">Packaging</a>
                        <div class="des">We offer packaging services to parcels/items to our clients. We ensure
                            that goods are packed and wrapped properly. The right type of packaging will help to
                            protect your goods.
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 padding-tb-15px">
                    <h4>To offer high-performance logistics solutions that would exceed customer expectations through
                        high quality service, cost control, continuous up-gradation of technology and development of our
                        human capital.</h4>
                </div>
                <div class="col-lg-5">
                    <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <div class="partners-item margin-bottom-tb-15px text-center">
                            <img src="assets/img/gls.png" alt="">
                        </div>
                    </div>
                    <!--//  partners item -->
